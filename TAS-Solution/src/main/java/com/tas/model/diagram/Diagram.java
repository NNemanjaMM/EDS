...
public class Diagram {
    ...
    public static class Flows {
        ...
        protected List<JAXBElement<Flow>> orBinaryOrHttpOrHttps;
         ...
         * 
         */
        public List<JAXBElement<Flow>> getOrBinaryOrHttpOrHttps() {
            if (orBinaryOrHttpOrHttps == null) {
                orBinaryOrHttpOrHttps = new ArrayList<JAXBElement<Flow>>();
            }
